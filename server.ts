...
import { GetMusicById , GetAllMusic ,GetCoverById} from "./controllers/play-msc";
import {
  authMiddleware,
  searchUsers,
  sendFriendRequest,
...
app.get("/api/audio", GetAllMusic);
app.get("/api/audio/:id/cover",GetCoverById);
app.get("/api/audio/:id",GetMusicById);
